...
INSERT INTO `account` (`id`, `account`, `level`, `password`, `email`, `cart`, `history`) VALUES
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`id`) REFERENCES `account` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
