                            ...
                            <div class="row">
                                    ...
                                    <div class="book_tabel_item">
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker11'>
                                                <input type='text' class="form-control" placeholder="入住時間" />
                                        ...
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker1'>
                                                <input type='text' class="form-control" placeholder="退房時間" />
                                                <span class="input-group-addon">
                                                    <i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="book_tabel_item">
                                        <div class="input-group">
                                            <select class="wide">
                                                <option data-display="成人數量">成人數量</option>
                                        ...
                                        <div class="input-group">
                                            <select class="wide">
                                                <option data-display="小孩數量">小孩數量</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                            </select>
                                ...
                                <div class="col-md-4">
                                    <div class="book_tabel_item">
                                        ...
                                        <a class="book_now_btn button_hover" href="#">立即訂房</a>
                                    </div>
                                </div>
                            </div>
                        </div>
